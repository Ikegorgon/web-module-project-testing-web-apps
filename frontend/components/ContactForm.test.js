...
test('renders ONE error message if user enters less then 5 characters into firstname.', async () => {
    ...
    userEvent.type(firstNameElement, "123");
...
test('renders ONE error message if user enters a valid first name and last name but no email.', async () => {
    ...
    const firstNameElement = screen.getByLabelText(/First Name*/i);
    userEvent.type(firstNameElement, "Johnny");
...
test('renders "email must be a valid email address" if an invalid email is entered', async () => {
    ...
    userEvent.type(emailElement, "test@gmail");
...
test('renders all firstName, lastName and email text when submitted. Does NOT render message if message is not submitted.', async () => {
    ...
    userEvent.type(firstNameElement, "Johnny");
    userEvent.type(lastNameElement, "Doe");
    userEvent.type(emailElement, "test@gmail.com");
    ...
    await waitFor(() => {
        ...
        const emailDisplay = screen.queryByText("test@gmail.com");
